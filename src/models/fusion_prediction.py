...
def _dump_pickle_to_json(pickle_path: str, json_path: str) -> None:
    ...
    if isinstance(artifact, dict):
        ...
        payload["selected_features_"] = _to_json_serializable(artifact.get("selected_features_"))
        ...
        if "best_estimator_" in artifact:
            payload["best_estimator_"] = _to_json_serializable(artifact.get("best_estimator_"))
    else:
...
if __name__ == "__main__":
    ...
    run_step('Dump model_frequence.pickle -> model_frequence.json',
             _dump_pickle_to_json,
             MODEL_FREQUENCE_PATH,
             SAVE_MODEL_FREQUENCE_PATH)

    run_step('Dump model_severite.pickle -> model_severite.json',
             _dump_pickle_to_json,
             MODEL_SEVERITE_PATH,
