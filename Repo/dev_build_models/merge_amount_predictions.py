...
if __name__ == "__main__":
    ...
    AMOUNT_PRED_PATH = os.path.join(DATA_DIR, 'sorties/pour_kaggle/Amount/pred_amount_reglineaire.csv')

    # =======================================================
    #-------- DEFINITION DES CHEMINS DE SORTIE -------------#
    # =======================================================
    SUBMIT_KAGGLE_PATH = os.path.join(DATA_DIR, 'sorties/Final_pred_for_submit/pred_prime_reglineaire.csv')
    ...
    submission_df.to_csv(os.path.join(DATA_DIR, 'sorties/pour_kaggle/Final_pred_for_submit/prime_prediction_reglineaire.csv'), index=False)
