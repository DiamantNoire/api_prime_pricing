...
def _init_session_defaults():
    ...
    st.session_state.setdefault("__show_login_dialog__", False)
...
def main():
    try:
        ...
        # --- Bouton de déconnexion (si connecté) | Si non connecté ---
        #page._bouton_connexion_deconnexion(statut=connected)
